module.exports = {
	run: async function(msg, p) {
		...
		return msg.channel.fetchMessages({limit: deleteCount}).then((msgs)=>msg.channel.bulkDelete(msgs)).catch(err => {throw new UserInputError(`Couldn't delete messages. Error: ${err.message}`)})
	},
	cat: 'mod',
	reqGuild: true,
